    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
            ...
            <div className="flex gap-2">
              {productData.sizes.map((item, index) => (
                <button
                  ...
                  className={`border py-2 px-4 bg-gray-100 hover:bg-green-100 ${
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            An E-Commerse Website is an Online platform the facilities the
            buying and selling{" "}
          </p>
          <p>
            Wide Product Range: Explore categories including fashion,
